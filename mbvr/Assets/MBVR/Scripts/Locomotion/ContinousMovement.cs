...
// Verändern: wir verwenden Objekte wie VelocityProvider und
// PoseProvider. Diese Komponenten setzen wir voraus, das können
// wir ja erzwingen. Dort können wir alles einstellen, was dort dazu gehört.
namespace VRKL.MBVR
{
    /// <summary>
    ...
    public abstract class ContinousMovement : MonoBehaviour
    {
        ...
        /// Default ist "Pad"
        /// </summary>
        [Tooltip("Button für das Abbremsen")] public ControllerButton decButton = ControllerButton.Pad;
